...
class TestInvalidLogin():
  ...
  def test_invalidLogin(self):
    ...
    self.driver.find_element(By.ID, "id_username").send_keys("abcd")
    self.driver.find_element(By.ID, "id_password").send_keys("abcd")
    self.driver.find_element(By.CSS_SELECTOR, ".btn").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".validation-summary-errors")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.XPATH, "//a[contains(@href, \'/login/\')]")
    assert len(elements) > 0
