...
urlpatterns = [
    ...
    path('lab/requestHistory/', views.requestHistoryProf, name='requestHistoryProf'),  #Page to manage lab settings
    path('lab/requestHistory/all/', views.requestHistoryProfAll, name='requestHistoryProfAll'),  #Page to manage lab settings
	path('lab/feedback/', views.labFeedback, name='labFeedback'),  #Professor page to view feedback and select TA's to view feedback
	path('lab/feedback/helper/<int:userID>/', views.labFeedbackHelper, name='labFeedbackHelper'),  #Professor/TA page to view the TA's feedback
